import { Cancion } from "./cancion"; //import se usa para importar la clase Cancion desde el archivo cancion.ts 
...
const plataforma = new PlataformaDeMusica(); //const se usa para declarar una constante 
